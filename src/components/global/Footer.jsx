              ...
              <form action="#" className="flex flex-col gap-5">
                ...
                <div className="flex flex-col min-[540px]:flex-row items-center justify-between gap-3">
                  ...
                  <input
                    type="submit"
                    value="Send"
                    className="text-white text-base font-semibold py-3 px-7 rounded-full cursor-pointer bg-amber-500 transition-all 
                  duration-500 hover:bg-white hover:text-gray-900"
                  />
                </div>
              </form>
            </div>
